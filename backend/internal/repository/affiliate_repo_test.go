...
func TestAffiliateDistributionRebateAmountRMB(t *testing.T) {
	require.InDelta(t, 40.0, affiliateDistributionRebateAmountRMB(2000, 1.4, 1.6), 1e-9)
}

func TestAffiliateDistributionRebateAmountRMBNegativeSpreadReturnsZero(t *testing.T) {
	require.InDelta(t, 0.0, affiliateDistributionRebateAmountRMB(2000, 1.6, 1.4), 1e-9)
}
