...
// GetClientIP returns the caller IP using Gin trusted-proxy parsing first.
// This avoids trusting user-supplied forwarding headers by default.
//
// In security-sensitive code paths prefer this helper (or GetTrustedClientIP),
// and configure server.trusted_proxies explicitly in deployment.
func GetClientIP(c *gin.Context) string {
	...
	// Fallback path for unusual contexts where ClientIP() is empty.
