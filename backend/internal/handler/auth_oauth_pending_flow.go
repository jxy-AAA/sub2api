...
func writeOAuthTokenPairResponse(c *gin.Context, tokenPair *service.TokenPair, setRefreshCookie func(*gin.Context, string)) {
	if setRefreshCookie != nil {
		setRefreshCookie(c, tokenPair.RefreshToken)
	}
