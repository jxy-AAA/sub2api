...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity openai_compatible anthropic_compatible"`
...
func (h *GroupHandler) GetStats(c *gin.Context) {
	...
	if h.dashboardService != nil {
		...
		stats, err := h.dashboardService.GetGroupStatsWithFilters(c.Request.Context(), startTime, endTime, 0, 0, 0, groupID, nil, nil, nil)
		if err != nil {
