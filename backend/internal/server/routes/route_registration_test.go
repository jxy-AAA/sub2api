...
func TestCriticalRoutesRemainRegistered(t *testing.T) {
	...
	expected := []string{
		...
		"DELETE /api/v1/admin/traces/:id",
		"POST /api/v1/admin/traces/batch-delete",
		"GET /api/v1/admin/traces/export",
		"GET /api/v1/admin/traces/rules",
		"POST /api/v1/admin/traces/rules",
		"GET /api/v1/admin/traces/rules/:id",
		"PUT /api/v1/admin/traces/rules/:id",
		"DELETE /api/v1/admin/traces/rules/:id",
