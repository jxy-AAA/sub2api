...
const (
	...
	PlatformOpenAICompatible    = domain.PlatformOpenAICompatible
...
const (
	...
	SettingKeyAffiliateRebateRate              = "affiliate_rebate_rate"               // Deprecated legacy affiliate rebate setting key
	SettingKeyAffiliateRebateFreezeHours       = "affiliate_rebate_freeze_hours"       // Deprecated legacy affiliate rebate setting key
	SettingKeyAffiliateRebateDurationDays      = "affiliate_rebate_duration_days"      // Deprecated legacy affiliate rebate setting key
	SettingKeyAffiliateRebatePerInviteeCap     = "affiliate_rebate_per_invitee_cap"    // Deprecated legacy affiliate rebate setting key
