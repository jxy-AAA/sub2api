<template>
  ...
  <div v-if="homeContent" class="min-h-screen">
    ...
    <iframe
      ...
      :src="safeHomeIframeUrl || undefined"
...
const safeHomeIframeUrl = computed(() => resolveSafeHomeIframeUrl(homeContent.value))
const isHomeContentUrl = computed(() => safeHomeIframeUrl.value !== null)
const sanitizedHomeContent = computed(() => renderSafeHomeContent(homeContent.value))
