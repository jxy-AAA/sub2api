      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.affiliate_enabled" class="rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800 dark:border-blue-800 dark:bg-blue-900/20 dark:text-blue-200">
              <p class="font-medium">???????</p>
              <p class="mt-1">
                ????????????????????????????? ?????? - ???????? 10?
              </p>
              <RouterLink to="/admin/affiliates/management" class="mt-3 inline-flex text-primary-600 hover:underline dark:text-primary-300">
                ????????????????
              </RouterLink>
            </div>
          </div>
...
void onAffiliateSearchInput;
void changeAffiliatePage;
void toggleAffiliateSelectAll;
void toggleAffiliateSelect;
void openAffiliateModal;
void askResetAffiliateUser;
