export default {
  ...
  affiliate: {
    title: '代理分销',
    description: '管理你的代理码、模型倍率和下级营业数据',
    yourCode: '我的代理码',
    inviteLink: '邀请链接',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
  ...
  affiliateManaged: {
    title: '下级管理',
    description: '在授权后查看自己下级的营业额、返利额度，并管理下级模型倍率。',
    noAccess: '暂未获得下级管理权限',
    noAccessHint: '请联系管理员为你授权查看营业额、返利额度或管理模型倍率。',
    ...
    pricingTitle: '下级模型倍率管理',
    pricingDescription: '仅可编辑你邀请树中的所有下级模型倍率，不包含全局数据。',
    ...
    save: '保存倍率',
    saving: '保存中...',
    saveSuccess: '下级模型倍率已更新',
    loadFailed: '加载下级管理数据失败',
    saveFailed: '更新下级模型倍率失败'
  },
  ...
  admin: {
    ...
    affiliates: {
      ...
      managementDescription: '管理代理层级、邀请码模型倍率和下级定价',
