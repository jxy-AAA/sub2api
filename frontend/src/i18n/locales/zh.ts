export default {
  ...
  nav: {
    ...
    redeem: '兑换',
    affiliate: '代理分销',
    affiliateManagement: '代理分销',
    affiliateInviteRecords: '每日营业额',
    affiliateRebateRecords: '返利额度',
    affiliateTransferRecords: '月度归档',
    affiliateAgentManagement: '代理管理',
    affiliateMonthlyArchives: '月度归档',
    downlineManagement: '下级管理',
    profile: '个人资料',
    users: '用户管理',
    groups: '分组管理',
    channels: '渠道管理',
  ...
  auth: {
    ...
    promoCodeLabel: '代理邀请码',
    promoCodePlaceholder: '输入代理邀请码（可选）',
    promoCodeValid: '代理邀请码有效',
    promoCodeInvalid: '无效的代理邀请码',
    promoCodeNotFound: '无效的代理邀请码',
    promoCodeExpired: '无效的代理邀请码',
    promoCodeDisabled: '无效的代理邀请码',
    promoCodeMaxUsed: '无效的代理邀请码',
    promoCodeAlreadyUsed: '无效的代理邀请码',
    promoCodeValidating: '代理邀请码验证中，请稍候...',
    promoCodeInvalidCannotRegister: '代理邀请码无效，请检查后重试或清空该字段',
    agentInvitationCodeLabel: '代理邀请码',
    agentInvitationCodePlaceholder: '输入代理邀请码（可选）',
    agentInvitationCodeValid: '代理邀请码有效',
    agentInvitationCodeInvalid: '无效的代理邀请码',
    agentInvitationCodeValidating: '代理邀请码验证中，请稍候...',
    agentInvitationCodeInvalidCannotRegister: '代理邀请码无效，请检查后重试或清空该字段',
  ...
  affiliateManaged: {
    title: '下级管理',
    description: '在授权后查看自己下级的营业额、返利额度，并管理下级分组倍率。',
    noAccess: '暂未获得下级管理权限',
    noAccessHint: '请联系管理员为你授权查看营业额、返利额度或管理分组倍率。',
    permissionsUpdated: '加载期间权限发生变化，未授权的版块已自动隐藏。',
    dailyRevenueTitle: '下级每日营业额',
    dailyRevenueDescription: '仅展示你自己的下级营业额，金额统一按 RMB 显示。',
    rebateTitle: '下级返利额度',
    rebateDescription: '仅展示你自己的下级返利余额与返利摘要。',
    pricingTitle: '下级分组倍率管理',
    pricingDescription: '仅可编辑你邀请树中的所有下级分组倍率，不包含全局数据。',
    searchPlaceholder: '搜索邮箱、用户名或邀请码',
    parentSearchPlaceholder: '搜索上级邮箱、用户名或 ID',
    refresh: '刷新',
    clearFilters: '清空筛选',
    date: '日期',
    totalRevenue: '营业额合计',
    totalBalance: '返利余额合计',
    directDownlines: '直属下级合计',
    directUsage: '直属营业额合计',
    rank: '排名',
    agent: '用户',
    revenueRmb: '营业额 (RMB)',
    balanceRmb: '返利额度 (RMB)',
    downlineSummary: '直属下级摘要',
    rebateSummary: '返利摘要',
    updatedAt: '更新时间',
    todayRebate: '今日返利',
    monthlyRebate: '本月返利',
    ...
    directAgents: '直属代理',
    treeTitle: '下级树',
    treeDescription: '这里只展示你自己的下级关系，不会出现全局管理员数据。',
    listTitle: '下级列表',
    level: '层级',
    parent: '上级',
    inviteCode: '邀请码',
    todayRevenue: '今日营业额 (RMB)',
    modelRates: '分组倍率',
    actions: '操作',
    editRates: '编辑倍率',
    noData: '暂无数据',
    rootNode: '根节点',
    depthLevel: '第 {depth} 层下级',
    agentRole: '代理',
    userRole: '普通用户',
    currentBalance: '当前返利余额',
    targetUser: '目标用户',
    rateDialogTitle: '编辑分组倍率',
    model: '模型',
    multiplier: '倍率',
    addRate: '新增分组倍率',
    remove: '删除',
    ...
    save: '保存倍率',
    saving: '保存中...',
    saveSuccess: '下级分组倍率已更新',
    loadFailed: '加载下级管理数据失败',
    saveFailed: '更新下级分组倍率失败'
  },
  ...
  admin: {
    ...
    affiliates: {
      invitesDescription: '查看所有代理的每日营业额排行榜',
      rebatesDescription: '查看所有代理的返利额度排行榜',
      transfersDescription: '查看每月返利清零后的归档记录',
      managementDescription: '管理代理层级、邀请码分组倍率和下级定价',
      monthlyDescription: '查看每月返利归档和清零记录',
      errors: {
      ...
      overview: {
        ...
        rebateRate: '分组倍率',
        invitedCount: '直属下级',
        rebatedInviteeCount: '活跃下级代理',
        availableQuota: '当前返利额度',
        historyQuota: '历史归档返利'
      }
    },
