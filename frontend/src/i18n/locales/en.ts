export default {
  ...
  nav: {
    ...
    affiliateManagement: 'Agent Distribution',
    affiliateInviteRecords: 'Daily Revenue',
    affiliateRebateRecords: 'Rebate Balance',
    affiliateTransferRecords: 'Monthly Archives',
    affiliateAgentManagement: 'Agent Management',
    affiliateMonthlyArchives: 'Monthly Archives',
    downlineManagement: 'Downline Management',
    profile: 'Profile',
    users: 'Users',
    groups: 'Groups',
    channels: 'Channels',
  ...
  auth: {
    ...
    promoCodeLabel: 'Agent Invitation Code',
    promoCodePlaceholder: 'Enter agent invitation code (optional)',
    promoCodeValid: 'Agent invitation code is valid',
    promoCodeInvalid: 'Invalid agent invitation code',
    promoCodeNotFound: 'Invalid agent invitation code',
    promoCodeExpired: 'Invalid agent invitation code',
    promoCodeDisabled: 'Invalid agent invitation code',
    promoCodeMaxUsed: 'Invalid agent invitation code',
    promoCodeAlreadyUsed: 'Invalid agent invitation code',
    promoCodeValidating: 'Validating agent invitation code...',
    promoCodeInvalidCannotRegister: 'Invalid agent invitation code. Please check and try again or clear the field',
    agentInvitationCodeLabel: 'Agent Invitation Code',
    agentInvitationCodePlaceholder: 'Enter agent invitation code (optional)',
    agentInvitationCodeValid: 'Agent invitation code is valid',
    agentInvitationCodeInvalid: 'Invalid agent invitation code',
    agentInvitationCodeValidating: 'Validating agent invitation code...',
    agentInvitationCodeInvalidCannotRegister: 'Invalid agent invitation code. Please check and try again or clear the field',
  ...
  affiliateManaged: {
    ...
    description: 'View your own downline revenue and rebate data, and edit descendant pricing when authorized.',
    noAccess: 'No downline management permissions yet',
    noAccessHint: 'Ask an administrator to grant downline revenue, rebate, or pricing management access.',
    permissionsUpdated: 'Permission changed while loading. Unauthorized sections have been hidden.',
    dailyRevenueTitle: 'Downline Daily Revenue',
    dailyRevenueDescription: 'Shows only your own downline revenue figures in RMB.',
    rebateTitle: 'Downline Rebate Balances',
    rebateDescription: 'Shows current rebate balances and summaries for your own downline only.',
    pricingTitle: 'Downline Pricing Management',
    pricingDescription: 'Edit model multipliers for descendants in your own invite tree.',
    searchPlaceholder: 'Search email, username, or invite code',
    parentSearchPlaceholder: 'Search parent email, username, or ID',
    refresh: 'Refresh',
    clearFilters: 'Clear Filters',
    date: 'Date',
    totalRevenue: 'Revenue Total',
    totalBalance: 'Rebate Balance Total',
    directDownlines: 'Direct Downlines',
    directUsage: 'Direct Usage',
    rank: 'Rank',
    agent: 'User',
    revenueRmb: 'Revenue (RMB)',
    balanceRmb: 'Rebate Balance (RMB)',
    downlineSummary: 'Direct Downline Summary',
    rebateSummary: 'Rebate Summary',
    updatedAt: 'Updated At',
    todayRebate: 'Today Rebate',
    monthlyRebate: 'Monthly Rebate',
    directUsers: 'Direct Users',
    directAgents: 'Direct Agents',
    treeTitle: 'Downline Tree',
    treeDescription: 'Browse descendants only. No global admin data appears here.',
    listTitle: 'Descendant List',
    level: 'Level',
    parent: 'Parent',
    inviteCode: 'Invite Code',
    todayRevenue: 'Today Revenue (RMB)',
    modelRates: 'Group Rates',
    actions: 'Actions',
    editRates: 'Edit Rates',
    noData: 'No data available',
    rootNode: 'Root',
    depthLevel: 'Level {depth}',
    agentRole: 'Agent',
    userRole: 'User',
    currentBalance: 'Current Balance',
    targetUser: 'Target User',
    rateDialogTitle: 'Edit Group Rates',
    model: 'Model',
    multiplier: 'Multiplier',
    addRate: 'Add Group Rate',
    remove: 'Remove',
    cancel: 'Cancel',
    save: 'Save Rates',
    saving: 'Saving...',
    saveSuccess: 'Downline group rates updated',
    loadFailed: 'Failed to load downline management data',
    saveFailed: 'Failed to update downline group rates'
  },
  ...
  admin: {
    ...
    affiliates: {
      invitesDescription: 'View the daily revenue ranking for all agents',
      rebatesDescription: 'View the rebate balance ranking for all agents',
      transfersDescription: 'View archived monthly rebate balances',
      managementDescription: 'Manage agent hierarchy, invite code pricing and child pricing',
      monthlyDescription: 'View monthly rebate reset archives',
      errors: {
      ...
      records: {
        ...
        startAt: 'Start date',
        endAt: 'End date',
        inviter: 'Parent Agent',
        invitee: 'Child Agent/User',
        user: 'User',
        affCode: 'Agent Code',
        order: 'Order',
        totalRebate: 'Daily Revenue',
        orderAmount: 'Top-up Amount',
        payAmount: 'Paid Amount',
        rebateAmount: 'Rebate Balance',
        paymentType: 'Payment Method',
        orderStatus: 'Order Status',
        transferAmount: 'Archived Amount',
        ...
        transferredAt: 'Archived At',
        rank: 'Rank',
        revenueUsd: 'Revenue (USD)',
        currentRebateBalance: 'Current Rebate Balance',
        archiveMonth: 'Archive Month'
      },
      overview: {
        title: 'Agent Overview',
        affCode: 'Agent Code',
        rebateRate: 'Model Multiplier',
        invitedCount: 'Direct Children',
        rebatedInviteeCount: 'Active Child Agents',
        availableQuota: 'Current Rebate Balance',
        historyQuota: 'Archived Rebate'
      }
    },
