...
const routes: RouteRecordRaw[] = [
  ...
  {
    path: '/affiliate/managed',
    alias: '/affiliate/manage',
    name: 'AffiliateManaged',
    component: () => import('@/views/user/AffiliateManagedView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      title: 'Downline Management',
      titleKey: 'nav.downlineManagement',
      descriptionKey: 'affiliateManaged.description'
    }
  },
  {
  ...
  },
  {
    ...
    redirect: '/admin/affiliates/daily-revenue'
  },
  {
    path: '/admin/affiliates/daily-revenue',
    alias: '/admin/affiliates/invites',
    name: 'AdminAffiliateRevenue',
    component: () => import('@/views/admin/affiliates/AdminAffiliateInvitesView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Affiliate Daily Revenue',
      titleKey: 'nav.affiliateInviteRecords',
      descriptionKey: 'admin.affiliates.invitesDescription'
    }
  },
  {
    path: '/admin/affiliates/rebate-balances',
    alias: '/admin/affiliates/rebates',
    name: 'AdminAffiliateRebates',
    component: () => import('@/views/admin/affiliates/AdminAffiliateRebatesView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Affiliate Rebate Balances',
  ...
  },
  {
    ...
    alias: '/admin/affiliates/transfers',
    name: 'AdminAffiliateManagement',
    component: () => import('@/views/admin/affiliates/AdminAffiliateManagementView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Affiliate Agent Management',
      titleKey: 'nav.affiliateAgentManagement',
      descriptionKey: 'admin.affiliates.managementDescription'
    }
  },
  {
    path: '/admin/affiliates/monthly-archives',
    name: 'AdminAffiliateMonthlyArchives',
    component: () => import('@/views/admin/affiliates/AdminAffiliateTransfersView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Affiliate Monthly Archives',
      titleKey: 'nav.affiliateMonthlyArchives',
      descriptionKey: 'admin.affiliates.monthlyDescription'
    }
  },
