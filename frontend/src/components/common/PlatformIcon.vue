<template>
  ...
  <svg v-if="iconPlatform === 'anthropic' || iconPlatform === 'anthropic_compatible'" :class="sizeClass" viewBox="0 0 16 16" fill="currentColor">
    <path
  ...
  <!-- OpenAI logo -->
  <svg v-else-if="iconPlatform === 'openai' || iconPlatform === 'openai_compatible'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path
  ...
  <svg v-else-if="iconPlatform === 'gemini'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2l1.89 7.2L21 12l-7.11 2.8L12 22l-1.89-7.2L3 12l7.11-2.8L12 2z" />
  </svg>
  <!-- Antigravity logo (cloud) -->
  <svg v-else-if="iconPlatform === 'antigravity'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
...
import { resolvePlatformBadgeKey } from '@/utils/platforms'
...
const iconPlatform = computed(() => resolvePlatformBadgeKey(props.platform) ?? props.platform ?? '')
