  ...
  it('normalizes affiliate overview to the new distribution shape', async () => {
    ...
    expect(result).toEqual({
      ...
      direct_children: [{
        ...
        today_business_rmb: 0,
        today_rebate_rmb: 2,
        direct_total_usage_usd: 11,
        direct_total_usage_rmb: 0,
        direct_user_usage_usd: 0,
        direct_user_usage_rmb: 0,
        direct_agent_usage_usd: 0,
        direct_agent_usage_rmb: 0,
        current_rebate_balance_rmb: 4,
